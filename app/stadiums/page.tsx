...
const stadiums = [
  /* Western Region */
  { name: "BC Place", city: "Vancouver", country: "Canada", capacity: "54,500", matches: 7, opened: 1983, surface: "Artificial Turf", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_blue.jpg", imagePosition: "center", mapLink: "https://maps.google.com/?q=BC+Place+Vancouver" },
  { name: "Lumen Field", city: "Seattle", country: "USA", capacity: "69,000", matches: 6, opened: 2002, surface: "Artificial Turf", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_fisheye.jpg", imagePosition: "center top", mapLink: "https://maps.google.com/?q=Lumen+Field+Seattle" },
  { name: "Levi's Stadium", city: "San Francisco Bay Area", country: "USA", capacity: "68,500", matches: 6, opened: 2014, surface: "Natural Grass", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_modern.jpg", imagePosition: "center", mapLink: "https://maps.google.com/?q=Levi's+Stadium+Santa+Clara" },
  { name: "SoFi Stadium", city: "Los Angeles", country: "USA", capacity: "70,240", matches: 8, opened: 2020, surface: "Artificial Turf", highlight: "Quarter-Final", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_red_sunset.jpg", imagePosition: "center", mapLink: "https://maps.google.com/?q=SoFi+Stadium+Los+Angeles" },
  /* Central Region */
  { name: "Estadio Akron", city: "Guadalajara", country: "Mexico", capacity: "49,850", matches: 4, opened: 2010, surface: "Natural Grass", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_aerial.jpg", imagePosition: "center top", mapLink: "https://maps.google.com/?q=Estadio+Akron+Guadalajara" },
  ...
  { name: "Estadio BBVA", city: "Monterrey", country: "Mexico", capacity: "53,500", matches: 4, opened: 2015, surface: "Natural Grass", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_red.jpg", imagePosition: "center", mapLink: "https://maps.google.com/?q=Estadio+BBVA+Monterrey" },
  { name: "NRG Stadium", city: "Houston", country: "USA", capacity: "72,220", matches: 7, opened: 2002, surface: "Artificial Turf", highlight: "Round of 16", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/football_stadium.png", imagePosition: "center", mapLink: "https://maps.google.com/?q=NRG+Stadium+Houston" },
  { name: "AT&T Stadium", city: "Dallas", country: "USA", capacity: "80,000", matches: 9, opened: 2009, surface: "Artificial Turf", highlight: "Semi-Final", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_fisheye.jpg", imagePosition: "center", mapLink: "https://maps.google.com/?q=AT%26T+Stadium+Arlington+Texas" },
  { name: "Arrowhead Stadium", city: "Kansas City", country: "USA", capacity: "76,416", matches: 6, opened: 1972, surface: "Natural Grass", highlight: "Quarter-Final", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_blue.jpg", imagePosition: "center 20%", mapLink: "https://maps.google.com/?q=Arrowhead+Stadium+Kansas+City" },
  /* Eastern Region */
  { name: "Mercedes-Benz Stadium", city: "Atlanta", country: "USA", capacity: "71,000", matches: 8, opened: 2017, surface: "Artificial Turf", highlight: "Semi-Final", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_modern.jpg", imagePosition: "center bottom", mapLink: "https://maps.google.com/?q=Mercedes-Benz+Stadium+Atlanta" },
  ...
  { name: "BMO Field", city: "Toronto", country: "Canada", capacity: "45,736", matches: 6, opened: 2007, surface: "Natural Grass", highlight: "Group Stage", highlightColor: "#475569", highlightBg: "#f1f5f9", image: "/stadium_aerial.jpg", imagePosition: "center 30%", mapLink: "https://maps.google.com/?q=BMO+Field+Toronto" },
  { name: "Gillette Stadium", city: "Boston", country: "USA", capacity: "65,878", matches: 7, opened: 2002, surface: "Artificial Turf", highlight: "Quarter-Final", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_fireworks.jpg", imagePosition: "center 20%", mapLink: "https://maps.google.com/?q=Gillette+Stadium+Boston" },
  { name: "Lincoln Financial Field", city: "Philadelphia", country: "USA", capacity: "69,796", matches: 6, opened: 2003, surface: "Natural Grass", highlight: "Round of 16", highlightColor: "#0369a1", highlightBg: "#e0f2fe", image: "/stadium_red.jpg", imagePosition: "center 40%", mapLink: "https://maps.google.com/?q=Lincoln+Financial+Field+Philadelphia" },
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            ...
            { label: "Host Countries", value: "3", icon: "flag", color: "#0ea5e9", bg: "#e0f2fe" },
            { label: "Largest Capacity", value: "83,714", icon: "people", color: "#d97706", bg: "#fef3c7" },
            { label: "Total Seats", value: "1.2M+", icon: "event_seat", color: "#0ea5e9", bg: "#e0f2fe" },
          ].map((s) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 mb-12">
          {stadiums.map((s) => (
            <div key={s.name} className="glass-card rounded-2xl overflow-hidden group cursor-pointer transition-all duration-300 hover:translate-y-[-3px]">
              ...
              {/* Content */}
              <div className="p-6">
                <h2 className="font-headline-lg mb-1 transition-colors group-hover:text-[#0ea5e9]"
                  style={{ fontFamily: "Outfit", fontSize: "20px", fontWeight: 800, color: "#f8fafc" }}>
                  {s.name}
                </h2>
                <div className="flex items-center gap-1.5 mb-5">
                  <span className="material-symbols-outlined text-[13px]" style={{ color: "#94a3b8" }}>location_on</span>
                ...
                <div className="grid grid-cols-3 gap-2 mb-5">
                  {[
                    { label: "Capacity", value: s.capacity, color: "#0ea5e9", bg: "#e0f2fe" },
                    { label: "Matches", value: String(s.matches), color: "#d97706", bg: "#fef3c7" },
                    { label: "Opened", value: String(s.opened), color: "#475569", bg: "#f8fafc" },
                  ].map((m) => (
                    <div key={m.label} className="text-center p-3 rounded-xl" style={{ background: m.bg, border: "1px solid #e2e8f0" }}>
                      ...
                      <p style={{ fontFamily: "JetBrains Mono", fontSize: "9px", textTransform: "uppercase", letterSpacing: "0.08em", color: "#94a3b8", marginTop: "3px" }}>{m.label}</p>
                    </div>
                  ))}
                </div>
